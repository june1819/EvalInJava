 ...
 * EvalInJava.java
 * Version 1.0
 * Created by Owen Chen on 2017-11-10.
 *
...
public class EvalInJava {
    ...
    public static void dataProcess(String s){
        String[] nums;
        String[] operators;
    ...
    public static void calMain(String[] o, String[] n){
        int i;
        String[] nSub;
        String[] oSub;
...
//        String strFormula = "(3-3)/((6-3)^2+2)*1.2";
        String strFormula = "(3+2)/(5*(22-3)*1)";
//        String strFormula = bf.readLine();
        System.out.println(strFormula);
        dataProcess(strFormula);
    }
}
